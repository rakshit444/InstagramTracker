 ...
 */
public class NotFollowingBack extends Fragment {
    ...
    public static NotFollowingBack newInstance(ArrayList<Datum> mList) {
        NotFollowingBack fragment = new NotFollowingBack();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        final RealmResults<Datum> ss = realm1.where(Datum.class).findAll();
    ...
    public void recycleView() {
        ...
        realm1 = Realm.getDefaultInstance();
        mRealm = realm1.where(Datum.class).findAll();
    ...
    private class DownloadFilesTask extends AsyncTask<ArrayList<Datum>, Integer, Long> {
        ...
        protected Long doInBackground(ArrayList<Datum>... params) {
            ...
            for (int i = 0; i < mList.size(); i++) {
                ...
                try {
                    ...
                    if (!mInstagramSession.getFirst_time_variable1().equals("true")) {

                        Log.i(TAG, mInstagramSession.getFirst_time_variable1() + "First time initialization");

                        RealmResults<RelationshipData1> query = realm1.where(RelationshipData1.class)
                    ...
                    realm1.copyToRealmOrUpdate(users1);

                    realm1.commitTransaction();

                    RealmResults<RelationshipData1> query1 = realm1.where(RelationshipData1.class)
                            .equalTo("id", user_id).findAll();
                    ...
                    if (!mInstagramSession.getFirst_time_variable1().equals("true")) {
                        ...
                        if ((outgoingStatus.equals("follows")) && (!newIncommingStatus.equals("followed_by"))) {
                            Log.i(TAG, "Not Following Back");
                            ...
                            realm1.executeTransaction(new Realm.Transaction() {
                                ...
                                public void execute(Realm realm) {
                                    ...
                                    realm1.copyToRealmOrUpdate(datum);

                                }
                            });


                        } else if (outgoingStatus.equals("follows") && (!newIncommingStatus.equals("followed_by"))) {
                            Log.i(TAG, "Followed Back");
                            realm1.beginTransaction();
                            realm1.where(Datum.class).beginsWith("id", user_id).findAll().deleteFirstFromRealm();
                            realm1.commitTransaction();
        ...
        protected void onPostExecute(Long result) {
            if (mInstagramSession.getFirst_time_variable1().equals("true")) {
                mInstagramSession.setFirst_time_variable1();
            }
